# ==============================================
# app.py — RAG Chatbot + SQL Console (Production)
# ==============================================
...
# ==============================================
# 2. Sidebar Navigation (Settings Removed)
# ==============================================
st.sidebar.title("🧭 Navigation")
page = st.sidebar.radio("Go to", ["Chat", "Documents", "SQL Console"])
...
if page == "Chat":
    st.title("💬 Chat (RAG)")
    st.markdown("Ask questions based on your uploaded PDFs or general knowledge.")
